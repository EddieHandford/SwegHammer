...
ARCHETYPES: Dict[str, Dict[str, Dict[str, int]]] = {
    ...
    "Aeldari": {
        "Battle Host": {
            "aeldari_aeldari_library_dire_avengers": 1,
            "aeldari_aeldari_library_guardian_defenders": 1,
            "aeldari_aeldari_library_rangers": 1,
            "aeldari_aeldari_library_fire_dragons": 1,
            "aeldari_aeldari_library_wraithguard": 1,
            "aeldari_aeldari_library_farseer": 1,
            "aeldari_aeldari_library_autarch": 1,
            "aeldari_aeldari_library_wave_serpent": 1,
            "aeldari_aeldari_library_falcon": 1,
        },
    },
    "Tyranids": {
        "Invasion Fleet": {
