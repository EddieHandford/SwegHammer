...
# Phase 2: the SCORE estimator (Battle method reusing the card geometry)
r6, r6g = batt._planner_score_value(unit, {"behind_enemy_lines", "engage_on_all_fronts"}, True, srr)
print(f"_planner_score_value  -> {r6:.4f} goal={r6g}  (SCORE estimator)")
