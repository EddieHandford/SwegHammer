...
- **Faction army rules** (10e codex army-rule level):
  ...
  - Death Guard: Disgustingly Resilient (FNP 5+ army-wide) + Contagions of Nurgle (Contagion Range escalates 3"/6"/9" by battle round per the printed schedule — DURA-AUDIT-D1; always-on Afflicted -1 Toughness from round 1 — DURA-AUDIT-D2; effect mix pending the chosen-Plague fix is round 2 -1 Leadership / round 3+ -1 to hit)
