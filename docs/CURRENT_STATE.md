...
**Last updated:** Wave 217 (2026-06-08) — Task #92 per-attack conditional invulnerable saves A/B landed: KEEP (fidelity-first), gated 7.21 → 7.26 within noise, no crater; new confirmed frame gated 7.26. Next build: CSM Legionaries "Veterans of the Long War".
